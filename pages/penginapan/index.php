                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="add.php" class="btn btn-primary">Add Penginapan</a>
                        </div>
...
<script>
    ...
    foreach ($penginapan_data as $penginapan) {
        echo "L.marker([" . $penginapan['latitude'] . ", " . $penginapan['longitude'] . "]).addTo(map)
              .bindPopup('<b>" . $penginapan['nama_penginapan'] . "</b><br>Harga: Rp " . number_format($penginapan['harga_kamar'], 3, ',', '.') . "<br>Fasilitas: " . $penginapan['fasilitas'] . "<br>Rating: " . $penginapan['rating'] . "/5<br>Jarak: " . $penginapan['jarak_lokasi'] . " km<br>Jenis: " . $penginapan['jenis_penginapan'] . "');";
    }
    ?>
</script>
