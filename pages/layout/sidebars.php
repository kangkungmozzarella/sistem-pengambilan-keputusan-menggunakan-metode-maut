...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= ($current_page == 'kriteria') ? 'active bg-gradient-primary' : '' ?>" href="../kriteria/">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= ($current_page == 'alternatif') ? 'active bg-gradient-primary' : '' ?>" href="../alternatif/">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">view_list</i>
                    </div>
                    <span class="nav-link-text ms-1">Data Alternatif</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= ($current_page == 'matriks') ? 'active bg-gradient-primary' : '' ?>" href="../matriks/">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= ($current_page == 'users') ? 'active bg-gradient-primary' : '' ?>" href="../users/">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
